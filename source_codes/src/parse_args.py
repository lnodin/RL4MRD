...
parser.add_argument('--in_channels', type=int, default=1,
                    help='In channels for HypER')
parser.add_argument('--out_channels', type=int, default=32,
                    help='Out channels for HypER')
parser.add_argument('--filt_h', type=int, default=1,
                    help='Filter height for HypER')
parser.add_argument('--filt_w', type=int, default=9,
                    help='Filter width for HypER')
...
parser.add_argument('--input_dropout_rate', type=float, default=0.2,
                    help='ConvE input layer dropout rate (default: 0.3)')
...
parser.add_argument('--lowfer_input_dropout', type=float, default=0.3,
                    help='LowFER feature dropout rate (default: 0.3)')
parser.add_argument('--lowfer_hidden_dropout1', type=float, default=0.4,
                    help='LowFER feature dropout rate (default: 0.4)')
parser.add_argument('--lowfer_hidden_dropout2', type=float, default=0.5,
                    help='LowFER feature dropout rate (default: 0.5)')
...
parser.add_argument('--k', type=int, default=10,
                    help='Latent dimension of MFB. (default: 100)')
...
parser.add_argument('--lowfer_state_dict_path', type=str, default='',
                    help='Path to the LowFER network state dict (default: '')')
parser.add_argument('--fourier_state_dict_path', type=str, default='',
                    help='Path to the Fourier network state dict (default: '')')
parser.add_argument('--conve_state_dict_path', type=str, default='',
                    help='Path to the ConvE network state dict (default: '')')
parser.add_argument('--hyper_state_dict_path', type=str, default='',
                    help='Path to the HypER network state dict (default: '')')
